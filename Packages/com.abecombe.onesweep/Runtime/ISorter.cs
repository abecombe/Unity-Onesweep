...
namespace Onesweep
{
    ...
    public interface ISorter : IDisposable
    {
        ...
        void Sort(GraphicsBuffer keyBuffer, GraphicsBuffer payloadBuffer, GraphicsBuffer sortCountBuffer, int sortCountBufferOffset);
        ...
        /// <param name="sortCountBuffer">Buffer containing the sort count (uint). Must not be null. Stride must be 4 bytes.</param>
        /// <param name="sortCountBufferOffset">Element offset in sortCountBuffer for the count value.</param>
        void Sort(CommandBuffer cmd, GraphicsBuffer keyBuffer, GraphicsBuffer payloadBuffer, GraphicsBuffer sortCountBuffer, int sortCountBufferOffset);
    }
}